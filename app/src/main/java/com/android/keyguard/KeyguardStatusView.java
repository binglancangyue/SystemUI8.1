...
public class KeyguardStatusView extends GridLayout {
    ...
    private BroadcastReceiver mUpdateStatuaBarVisibleReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context ctx, Intent intent) {
            ...
            if (shouldRefresh != statusBarVisible) {
                if (statusBarVisible)  refresh();
                shouldRefresh = statusBarVisible;
            }
            if (DEBUG_NOT_REFRESH) android.util.Log.d(TAG_NOT_REFRESH, "KeyguardStatusView-onSystemUiVisibilityChange: statusBarVisible = " + statusBarVisible);
        }
    };
    ...
    private KeyguardUpdateMonitorCallback mInfoCallback = new KeyguardUpdateMonitorCallback() {
        ...
        public void onTimeChanged() {
            if (!shouldRefresh && StatusBar.ALLOW_NOT_REFRESH) {
                if (DEBUG_NOT_REFRESH) Log.d(TAG_NOT_REFRESH, "should not refresh time in keyguard as statusbar invisible");
                return;
                /* @}SPRD bug 814301&819675 :add control of whether refresh statusbar icons*/
            }
            refresh();
    ...
    public ColorStateList getKeyguardTextColor() {
        return mClockView.getTextColors();
    }
