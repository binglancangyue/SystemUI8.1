...
public class KeyguardSimPukView extends KeyguardPinBasedInputView {
    ...
    //SPRD:694239
    public static final String SIM_PUK_REMAINTIMES = "gsm.sim.puk.remaintimes";
    ...
    private class StateMachine {
        ...
        void reset() {
            ...
            if (SubscriptionManager.isValidSubscriptionId(mSubId)) {
                ...
                /* SPRD:694239 @{ */
                mCallback.dismiss(true, KeyguardUpdateMonitor.getCurrentUser());
                getPukRemainingAttemptsDialog(mRemainTimes).dismiss();
            }
    ...
    public void onPause() {
        // dismiss the dialog.
        // SPRD:694239 add PUK verify success prompt.
