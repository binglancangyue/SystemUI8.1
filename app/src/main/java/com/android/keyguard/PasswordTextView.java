...
public class PasswordTextView extends View {
    ...
    public void setSecurityMessageDisplay(SecurityMessageDisplay mSecurityMessageDisplay) {
        this.mSecurityMessageDisplay = mSecurityMessageDisplay;
    }

    public void append(char c) {
        android.util.Log.d("PasswordTextView", "append:" + c);
