            ...
            synchronized(this) {
                ...
                try {
                        ...
                        if (!audioManager.isMusicActiveRemotely()) {
                            synchronized (mQueueAudioFocusLock) {
                                if (mAudioManagerWithAudioFocus == null) {
                                    ...
                                    //SPRD:Bug 713834 Ringtone rings while notification is ringing.
                                    audioManager.requestAudioFocus(mAudioFocuslistener, mCmd.attributes,
                                                focusGain, 0);
                                    /*@}*/
                    ...
                    try {
                        ...
                        /*SPRD:Bug 713834 Ringtone rings while notification is ringing.*/
                        Log.d(mTag, "audioManager.getMode()="+audioManager.getMode());
