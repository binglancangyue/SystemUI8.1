...
public class TunerFragment extends PreferenceFragment {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        if (SystemProperties.getInt("ro.hotspot.enabled", 1) == 1) {
             PreferenceScreen preferenceScreen = (PreferenceScreen)getPreferenceScreen().findPreference("status_bar");
             if (null != preferenceScreen) {
                 Preference hotspot = (Preference)preferenceScreen.findPreference("hotspot");
                 if (null != hotspot) {
                     preferenceScreen.removePreference(hotspot);
                 }
             }
        }
        ...
        if (Settings.Secure.getInt(getContext().getContentResolver(), SETTING_SEEN_TUNER_WARNING,
                0) == 0) {
            if (getFragmentManager().findFragmentByTag(WARNING_TAG) == null && !getActivity().isFinishing()) {
            ...
            return new AlertDialog.Builder(getContext())
                    ...
                    .setPositiveButton(R.string.got_it, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            /* sprdroid Bug853499 1 NullPointerException in monkey @{ */
                            if (getContext() != null) {
