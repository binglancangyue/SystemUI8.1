...
public class NavigationBarInflaterView extends FrameLayout
    ...
    //by lym start
    public static final String DVR = "camera";
    public static final String DVR_BACK = "camera_back";
...
//            }
    ...
    protected void inflateLayout(String newLayout) {
        ...
        for (String s : sets) {
            Log.d(TAG, "inflateLayout:sets " + s);
        }
        Log.d(TAG, "inflateLayout:sets " + sets + "");
    ...
    private View createView(String buttonSpec, ViewGroup parent, LayoutInflater inflater) {
        ...
        switch (button) {
            ...
            case VOICE:
                ...
                Log.d(TAG, "createView:VOICE ");
                break;
            case DVR:
                v = inflater.inflate(R.layout.dvr, parent, false);
                Log.d(TAG, "createView:DVR ");
                break;
            case DVR_BACK:
                v = inflater.inflate(R.layout.dvr_back, parent, false);
                Log.d(TAG, "createView:DVR_BACK ");
                break;
            case SETTINGS:
                v = inflater.inflate(R.layout.settings, parent, false);
                break;
            case KEY:
