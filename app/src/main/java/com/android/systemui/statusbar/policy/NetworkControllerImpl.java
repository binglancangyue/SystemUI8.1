...
public class NetworkControllerImpl extends BroadcastReceiver
    ...
    private boolean mIsWifiCallingActive = false;
...
//        mCallbackHandler = callbackHandler;
    ...
    /*
     * SPRD: Bug 673215 showing User notifications on
            ...
            new IImsRegisterListener.Stub() {
                    ...
                    public void imsRegisterStateChange(boolean isRegistered)
                        ...
                        if (mImsType == ImsConfig.FeatureConstants.FEATURE_TYPE_VOICE_OVER_WIFI) {
                            mIsWifiCallingActive = true;
                        } else {
                            mIsWifiCallingActive = false;
                        }
                        updateNotification();
                    }
    };
    ...
    protected void updateNotification() {
        ...
        Log.d(TAG, "updateNotification mVowifiNotificationShown= " + mVowifiNotificationShown
                + " mIsWifiCallingActive = " + mIsWifiCallingActive);
        if (!mVowifiNotificationShown && mIsWifiCallingActive) {
    ...
    private void registerListeners() {
        ...
        // SPRD:change for  Bug 673215
        filter.addAction(ImsManager.ACTION_IMS_SERVICE_UP);
        filter.addAction(ImsManager.ACTION_IMS_SERVICE_DOWN);
        // SPRD: Add HD audio icon in cucc for bug699703.
        ...
        Log.i(TAG, "showEmergencyCallLimitNotification = " + mShowEmergencyCallLimitedNotification);
    ...
    private void unregisterListeners() {
        ...
        try {
            if (mIsImsListenerRegistered) {
                ...
                /* SPRD: Bug 681664 when imsservice restart,we need to re-regist ImsListener. @{ */
                if (mIImsServiceEx != null) {
    ...
    /* SPRD: modify by BUG 781581,798705 and 826505 sync to refresh signal icon @{ */
    private void refreshMobileSignalController(SignalCallback cb) {
        for (int i = 0; i < mMobileSignalControllers.size(); i++) {
            MobileSignalController mobileSignalController = mMobileSignalControllers.valueAt(i);
            mobileSignalController.notifyListeners(cb);
            mobileSignalController.refreshImsIcons(cb);
            mobileSignalController.refreshVoWiFiIcons(cb);
            mobileSignalController.refreshMobileDataConnected(cb);
        }
    }
    /* @} */
    ...
    public void addCallback(SignalCallback cb) {
        ...
        // SPRD: modify by BUG 781581 sync to refresh signal icon
        refreshMobileSignalController(cb);
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        /* SPRD: Add HD audio icon in cucc for bug699703. @{ */
            ...
            mCallbackHandler.setMobileHdVoiceIndicators(isHdVoiceSupport,
                    ...
                    TelephonyIconsEx.ICON_HD_VOICE);
        /* @} */
    ...
    static class Config {
        ...
        // SPRD: modify by BUG 833682
        boolean showDataDisable = false;
        static Config readConfig(Context context) {
            ...
            // SPRD: modify by BUG 833682
            config.showDataDisable = res.getBoolean(R.bool.config_showDataDisable);
            return config;
        }
    }
}
