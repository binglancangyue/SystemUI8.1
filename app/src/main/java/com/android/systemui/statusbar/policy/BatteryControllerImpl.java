...
// NOTE: Bug #746994 low power Feature BEG-->
        if (PowerManagerEx.isPowerControllerEnabled()) {
            (new PowerManagerEx(mContext)).forcePowerSaveMode(powerSave);
            return;
        }
// <-- NOTE: Bug #746994 low power Feature END
    ...
    private void setPowerSave(boolean powerSave) {
        ...
        /*SPRD bug 780822:Don't update statusbar in SUPPORT_SUPER_POWER_SAVE*/
        if(StatusBar.SUPPORT_SUPER_POWER_SAVE){
