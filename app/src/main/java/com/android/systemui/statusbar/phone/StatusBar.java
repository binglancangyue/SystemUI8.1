...
import com.android.systemui.statusbar.activity.StatusChangeBroadcastReceiver;
import com.android.systemui.statusbar.activity.bean.WeatherBean;
...
public class StatusBar extends SystemUI implements DemoMode,
        ...
        ColorExtractor.OnColorsChangedListener, ConfigurationListener , OnUpdateWeatherListener {
    ...
    protected static final int MSG_UPDATE_WEATHER = 10086;
    ...
    //debug not refresh view when statusbar invisible
    /*SPRD bug 814301&819675 :add control of whether refresh statusbar icons @{ */
    public static final boolean DEBUG_NOT_REFRESH = false;
    public static final boolean ALLOW_NOT_REFRESH = false;
    public static final String TAG_NOT_REFRESH = "StatusBar_not_refresh";
    ...
    /* SPRD:bug 725369*/
    private static boolean mLaunchTransitionTimeout = false;
    ...
    private LinearLayout mKeyguardCarrierLabel;
    ...
    private boolean darkTextInKeyguard;
    ...
    public void start() {
        ...
        mReceiver = new StatusChangeBroadcastReceiver(null);
...
//        }
    ...
    protected void makeStatusBarView() {
        ...
        if (UserManager.get(mContext).isUserSwitcherEnabled()) {
         ...
         /* SPRD bug 780822  Keyguard super power */
        mKeyguardCarrierLabel = (LinearLayout) mStatusBarWindow.findViewById(
                R.id.carriers_layout);
        /* @} */
        ...
        if(SUPPORT_SUPER_POWER_SAVE && mNotificationPanel != null){
            ...
            if(mKeyguardCarrierLabel != null){
                mKeyguardCarrierLabel.setVisibility(mode == PowerManagerEx.MODE_ULTRASAVING ? View.INVISIBLE : View.VISIBLE);
            }
            /*@}*/
        }
        /*@}*/
    ...
    /* bug744809 QSPanel overlay with QSDetail */
    public void dismissOverlayIfNeeded() {
        Log.d(TAG, "dismissOverlayIfNeeded");
        if (qsFragment != null) {
            qsFragment.makeSureNoOverlay();
        }
    }
    ...
    public static SignalClusterViewBase reinflateSignalCluster(View view) {
        ...
        if (signalCluster != null) {
            ...
            if (parent instanceof ViewGroup) {
                ...
                SignalClusterViewBase newCluster = (SignalClusterViewBase) LayoutInflater.from(context)
    ...
    public void onColorsChanged(ColorExtractor extractor, int which) {
        Log.d(TAG, "onColorsChanged_2:flag = " + which);
        if (!ENABLE_LOCKSCREEN_WALLPAPER) {
            /* SPRD: Bug817655 wallpapercolortest fail which set falg = 3 @{ */
            try {
                darkTextInKeyguard = extractor.getColors(which,ColorExtractor.TYPE_NORMAL).supportsDarkText();
            } catch(Exception e) {
                e.printStackTrace();
            }
            /* @} */
            Log.d(TAG, "onColorsChanged_2:darkTextInKeyguard?" + darkTextInKeyguard);
        }
        updateTheme();
    }
    ...
    public void setSystemUiVisibility(int vis, int fullscreenStackVis, int dockedStackVis,
        ...
        if (diff != 0) {
            ...
            boolean visible = (vis & View.STATUS_BAR_UNHIDE) != 0;
            if (statusBarVisible != visible && mTopHidesStatusBar) {
                statusBarVisible = visible;
                if (ALLOW_NOT_REFRESH) {
                    mContext.sendBroadcast(new Intent("statusbar visibility changed").putExtra("visible", statusBarVisible));
                    Log.d(TAG_NOT_REFRESH, "send statusbar visibility changed Broadcast1");
                }
            } else {
    ...
    void checkBarMode(int mode, int windowState, BarTransitions transitions) {
        ...
        if (SUPPORT_SUPER_POWER_SAVE ) {
            powerSave = (getPowerSaveModeInternal() == PowerManagerEx.MODE_LOWPOWER);
        } else {
            powerSave = mBatteryController.isPowerSave();
        }
    ...
    public void executeRunnableDismissingKeyguard(final Runnable runnable,
        ...
        dismissKeyguardThenExecute(() -> {
            ...
            if (dismissShade) {
            ...
            } else if ((isInLaunchTransition() && mNotificationPanel.isLaunchTransitionFinished()) ||(mStatusBarKeyguardViewManager.isBouncerShowing() && mLaunchTransitionTimeout == true)) {
               ...
               /* SPRD:bug 725369*/
                mLaunchTransitionTimeout = false;
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            /*SPRD bug 780822:Super power feature*/
                ...
                Log.d(TAG, "action="+action+",curMode="+curMode);
                ...
                /* SPRD bug 723104  Keyguard super power */
                if (mKeyguardCarrierLabel != null) {
                    mKeyguardCarrierLabel.setVisibility(curMode == PowerManagerEx.MODE_ULTRASAVING ? View.INVISIBLE : View.VISIBLE);
                }
                /*@}*/
    ...
    protected void updateTheme() {
        ...
        final boolean lockDarkText = !ENABLE_LOCKSCREEN_WALLPAPER ? darkTextInKeyguard : mColorExtractor.getColors(WallpaperManager.FLAG_LOCK, true
                /* ignoreVisibility */).supportsDarkText();
        if (mNotificationPanel != null) mNotificationPanel.applyKeyguardDarkTextColor(lockDarkText);
    ...
    public void applyKeyguardTextColor(int color) {
        Log.d(TAG, "applyKeyguardTextColor");
        if (mKeyguardCarrierLabel == null) return;
        int count = mKeyguardCarrierLabel.getChildCount();
        Log.d(TAG, "mKeyguardCarrierLabel.getChildCount() = " + count);
        for (int i=0; i<count; i++) {
            View v = mKeyguardCarrierLabel.getChildAt(i);
    ...
    public boolean onBackPressed() {
        /* SPRD: bug 743261 Emergency Dialer can not destory when press back key @{ */
        if (mLaunchTransitionFadingAway) {
            mNotificationPanel.animate().cancel();
            onLaunchTransitionFadingEnded();
        }
        ...
        if (mNotificationPanel.isQsExpanded() || mNotificationPanel.isQsCustomizing()) {
    ...
    public void onHintFinished() {
        ...
        mNotificationPanel.getKeyguardBottomAreaView().updateIconColor(true, false);
        mNotificationPanel.getKeyguardBottomAreaView().updateIconColor(false, false);
    }

    public void onCameraHintStarted() {
        //SPRD: fix for bug 856637
        ...
        dismissKeyguardThenExecute(new OnDismissAction() {
            ...
            public boolean onDismiss() {
                AsyncTask.execute(new Runnable() {
                    @Override
                    public void run() {
                        /* SPRD: Add to start notification settings in owner user {@ */
    ...
    private PackageManager getPackageManagerForUser(Context context, int userId, String name) {
    ...
    private void bindGuts(final ExpandableNotificationRow row, MenuItem item) {
        ...
        if (gutsView instanceof NotificationInfo) {
            ...
            PackageManager pmUser = getPackageManagerForUser(mContext,
                    userHandle.getIdentifier(), sbn.getPackageName());
    ...
    public void setTopAppHidesStatusBar(boolean topAppHidesStatusBar) {
        if (mTopHidesStatusBar != topAppHidesStatusBar) {
            if (!topAppHidesStatusBar) {
                statusBarVisible = true;
                if (ALLOW_NOT_REFRESH) {
                    mContext.sendBroadcast(new Intent("statusbar visibility changed").putExtra("visible", statusBarVisible));
                    Log.d(TAG_NOT_REFRESH, "send statusbar visibility changed Broadcast");
                }
            }
        }
        /* @} SPRD bug 814301&819675 :add control of whether refresh statusbar icons*/
    ...
    protected void inflateViews(Entry entry, ViewGroup parent) {
        ...
        PackageManager pmUser = getPackageManagerForUser(mContext,
                entry.notification.getUser().getIdentifier(), sbn.getPackageName());
        if (entry.row != null) {
            entry.reset();
    ...
    private final class NotificationClicker implements View.OnClickListener {
        ...
        public void onClick(final View v) {
            ...
            /* SPRD: Add for bug 832110,add special flag for pendingintent,so that system user would not
               resove appclone info. in function resolveIntentForAppClone in PackageManagerServiceExUtils.java @{ */
            Intent copyIntent = intent.getIntent();
            copyIntent.addFlags(Intent.FLAG_FOR_APPCLONE);

            final boolean afterKeyguardGone = intent.isActivity()
                    && PreviewInflater.wouldLaunchResolverActivity(mContext, copyIntent,
                            mCurrentUserId);
            /* @} */
            dismissKeyguardThenExecute(new OnDismissAction() {
                @Override
                    ...
                    final Runnable runnable = new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (intent != null) {
                                ...
                                try {
                                    /* SPRD: Add for bug 827243,add Extra info. for pendingintent,
                                       so that system user would not resove appclone info. in function
                                       resolveIntentForAppClone in PackageManagerServiceExUtils.java @{ */
                                    Intent intentWithFlag = new Intent();
                                    intentWithFlag.addFlags(Intent.FLAG_FOR_APPCLONE);
                                    intent.send(mContext, 0, intentWithFlag, null, null, null,
                                            getActivityOptions());
                                    /* @} */
                                } catch (PendingIntent.CanceledException e) {
                                    // the stack trace isn't very helpful here.
    ...
    protected void updateCarrierLabelVisibility() {
        ...
        final boolean makeVisible = mPanelExpanded && mState != StatusBarState.KEYGUARD;
    ...
    public static final boolean SUPPORT_SUPER_POWER_SAVE = android.os.SystemProperties.getBoolean("ro.sys.pwctl.ultrasaving",false);
