...
public class PhoneStatusBarPolicy implements Callback, Callbacks,
    ...
    public static final int LOCATION_STATUS_ICON_ID = CustomValue.LOCATION_STATUS_ICON[CustomValue.STATUS_BAR_ICON_TYPE];
    //public static final int LOCATION_STATUS_ICON_ID = R.drawable.stat_sys_location_bx_7in;
    ...
    public final static boolean RECENTS_SPRD = "1".equals(SystemProperties.get("persist.recents.sprd"));// SPRD: new feature of sprd recents
