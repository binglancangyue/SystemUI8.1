...
public class NotificationPanelView extends PanelView implements
    ...
    private static final int CLOCK_DIFF_HEIGHT = 40;
    ...
    private boolean mDarkKeyguardText = false;
    ...
    private void positionClockAndNotifications() {
        ...
        if (mStatusBarState != StatusBarState.KEYGUARD) {
            ...
            if (animate || mClockAnimator != null) {
                startClockAnimation(mClockPositionResult.clockX, mClockPositionResult.clockY +CLOCK_DIFF_HEIGHT);
            } else {
                mKeyguardStatusView.setX(mClockPositionResult.clockX);
                mKeyguardStatusView.setY(mClockPositionResult.clockY +CLOCK_DIFF_HEIGHT);
            }
    ...
    public void onAnimationToSideStarted(boolean rightPage, float translation, float vel) {
        ...
        if (start) {
            ...
            if (KeyguardBottomAreaView.CAMERA_LAUNCH_SOURCE_AFFORDANCE.equals(
                ...
                if(mKeyguardBottomArea.launchAudioProfile()) return;
    ...
    public void onIconClicked(boolean rightIcon) {
        ...
        if (rightIcon) {
            ...
            mKeyguardBottomArea.updateIconColor(false, true);
        } else {
            ...
            mKeyguardBottomArea.updateIconColor(true, true);
        }
    }
     ...
     */
    private boolean isFaceLockEnabled() {
    ...
    public void applyKeyguardDarkTextColor(boolean darkText) {
        mDarkKeyguardText = darkText;
        Log.d(TAG, "applyKeyguardTextColor:darkText?" + darkText);
        int color = darkText ? Color.BLACK : Color.WHITE;
        mKeyguardBottomArea.applyKeyguardTextColor(color);
        mStatusBar.applyKeyguardTextColor(color);
    }

    private void setDarkAmount(float amount) {
        Log.d(TAG, "setDarkAmount:amount=" + amount);
        mDarkAmount = amount;
        mKeyguardStatusView.setDark(mDarkAmount);
        applyKeyguardDarkTextColor(mDarkKeyguardText);
        positionClockAndNotifications();
    }
