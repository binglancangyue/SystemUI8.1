...
/* Bug 705343 lock screen shaking to change song @{ */
import com.sprd.music.KeyguardMusicManager;
...
public class StatusBarKeyguardViewManager implements RemoteInputController.Callback {
    ...
    private static final String TOGGLEPAUSE_ACTION = "com.android.music.musicservicecommand.togglepause.sprd";
    private static final String PREVIOUS_ACTION = "com.android.music.musicservicecommand.previous.sprd";
    private static final String NEXT_ACTION = "com.android.music.musicservicecommand.next.sprd";
    private AudioManager mAudioManager;
    private static final int CHECKOUT_MUSIC_ACTIVE_MS = 2000;
    ...
    public void registerStatusBar(StatusBar statusBar,
        ...
        Log.d(TAG, "isLockMusicEnabledSetting:"+isLockMusicEnabledSetting);
                ...
                mHandler.postDelayed(new Runnable() {
                    public void run(){
                        if (mAudioManager != null) {
                            Log.d(TAG, "mIntentReceiver -- isMusicActive: " + mAudioManager.isMusicActive());
