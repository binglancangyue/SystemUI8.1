        ...
        new AsyncTask<SparseArray<Bitmap>, Void, ArrayList<UserRecord>>() {
            ...
            protected ArrayList<UserRecord> doInBackground(SparseArray<Bitmap>... params) {
                ...
                for (UserInfo info : infos) {
                    /* Modify to not show appclone user in systemui {@ */
                    AppCloneUserInfo appCloneUserInfo = new AppCloneUserInfo(info);
                    if(appCloneUserInfo.isAppClone()){
                        Log.w(TAG, "User: " + info.name + " for appClone, don't show!");
                        continue;
                    }
                    /* @} */
