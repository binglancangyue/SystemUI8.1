...
public class NotificationStackScrollLayout extends ViewGroup
    ...
    private BroadcastReceiver mUpdateStatuaBarVisibleReceiver = new BroadcastReceiver() {
        ...
        if (DEBUG_NOT_REFRESH) Log.d(TAG_NOT_REFRESH, "StatusBarIconView-onSystemUiVisibilityChange: statusBarVisible = " + statusBarVisible);
        }
    };
    ...
    public void invalidate() {
        if (!shouldRefresh && StatusBar.ALLOW_NOT_REFRESH) {
            if (DEBUG_NOT_REFRESH) Log.d(TAG_NOT_REFRESH, "NotificationStackScrollLayout no necessary to invalidate");
            return;
      }
        super.invalidate();
    }
    ...
    /* SPRD: Bug 692452 new feature of lock recent apps for build @{ */
    @Override
    ...
    private boolean onScrollTouch(MotionEvent ev) {
        ...
        /* sprdroid Bug836587 IllegalArgumentException in monkey @{ */
        try {
