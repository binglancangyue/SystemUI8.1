...
public abstract class PanelView extends FrameLayout {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getActionMasked()) {
            case MotionEvent.ACTION_DOWN:
                ...
                mStatusBar.dismissOverlayIfNeeded();
                break;
    ...
    public void setExpandedHeightInternal(float h) {
        ...
        if(shouldUpdateBarPanelExpansion()) {
            notifyBarPanelExpansionChanged();
        }
    }

    private boolean isKeyguardSecure() {
        return mStatusBar != null && mStatusBar.isKeyguardSecure();
    }

    private boolean shouldUpdateBarPanelExpansion() {
        return mExpandedFraction == 1 || mExpandedFraction == 0 || !isKeyguardSecure();
    }
