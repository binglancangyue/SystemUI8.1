...
public class VolumeDialogControllerImpl implements VolumeDialogController, Dumpable {
    ...
    private boolean updateActiveStreamW(int activeStream) {
        ...
        /*SPED bug 730527:Sync audioprofile volume*/
        sendActiveStreamEvent(activeStream);
        /*@}*/
    ...
    /*SPED bug 730527:Sync audioprofile volume*/
    private void sendActiveStreamEvent(int stream){
        Log.d(TAG, "sendActiveStreamEvent stream="+stream);
        Intent intent = new Intent("com.android.sprd.active_stream");
        intent.putExtra("active_stream", stream);
    ...
    class C implements Callbacks {
        ...
        public void add(Callbacks callback, Handler handler) {
            /* SPRD: Bug 884450 ConcurrentModificationException in mCallbackMap and add synchronized for mCallbackMap. @{ */
