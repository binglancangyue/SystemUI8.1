...
public class VolumeDialogImpl implements VolumeDialog, TunerService.Tunable {
    ...
    private void initDialog() {
        ...
        if (mRows.isEmpty()) {
            /*SPRD bug 733375:Change sort to display same as audioprofile*/
...
//                        R.drawable.ic_volume_ringer, R.drawable.ic_volume_ringer_mute, true);
    ...
    private void updateFooterH() {
        ...
        if (fullWasVisible) mZenPanel.updateSwitch();
    ...
    private void updateVolumeRowH(VolumeRow row) {
       ...
       /* Log.d(TAG,"updateVolumeRowH isRingVibrate="+isRingVibrate+" isRingSilent="+isRingSilent+" zenMuted="+zenMuted+" ss.routedToBluetooth="+ss.routedToBluetooth+" ss.muted="+ss.muted+" mAutomute="+mAutomute+" ss.level="+ss.level);*/
        final int iconRes =
...
/*
        Log.d(TAG,"updateVolumeRowH iconRes="+iconRes+" row.iconMuteRes="+row.iconMuteRes+" row.iconRes="+row.iconRes+"row.cachedIconRes="+row.cachedIconRes);*/
