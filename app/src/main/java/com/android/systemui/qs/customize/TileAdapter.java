...
public class TileAdapter extends RecyclerView.Adapter<Holder> implements TileStateListener {
    ...
    public void setTileSpecs(List<String> currentSpecs) {
        ...
        if(mCurrentSpecs != null && mCurrentSpecs.equals(mHost.getDefaulTilesHashMap().get(ActivityManager.getCurrentUser()))){
            Log.d("TileAdapter", "setTileSpecs is the same as default xml!");
            return;
        }
        /*@}*/
    ...
    private TileInfo getAndRemoveOther(String s) {
        for (int i = 0; i < mOtherTiles.size(); i++) {
            if (mOtherTiles.get(i).spec != null && mOtherTiles.get(i).spec.equals(s)) {
    ...
    public class Holder extends ViewHolder {
        ...
        public void startDrag() {
            itemView.animate()
                    ...
                    .scaleX(DRAG_SCALE)
                    .scaleY(DRAG_SCALE);
            /* sprdroid Bug904385 nullpointerexception in monkey @{ */
            if(mTileView == null){
                Log.d(TAG,"startDrag mTitleView is null and return");
                return;
            }
            /* @{ sprdroid Bug904385 nullpointerexception*/
        ...
        public void stopDrag() {
            ...
            /* sprdroid Bug904385 nullpointerexception in monkey @{ */
            if(mTileView == null){
                Log.d(TAG,"stopDrag mTitleView is null and return");
                return;
            }
            /* @{ sprdroid Bug904385 nullpointerexception*/
            mTileView.findViewById(R.id.tile_label).animate()
    ...
    private final ItemTouchHelper.Callback mCallbacks = new ItemTouchHelper.Callback() {
        ...
        public void onSelectedChanged(ViewHolder viewHolder, int actionState) {
            ...
            if (mCurrentDrag != null) {
                ...
                /*SPRD bug 709506:Maybe cause ArrayIndexOutOfBoundsException*/
