...
public class HotspotTile extends QSTileImpl<AirplaneBooleanState> {
    ...
    /*SPRD bug 679787:Can't open hotspot if isDataSaverEnabled.*/
    private DataSaverController mDataSaverController = null;
    ...
    protected void handleClick() {
        ...
        /*SPRD bug 679787:Can't open hotspot if isDataSaverEnabled.*/
        if(mDataSaverController != null && mDataSaverController.isDataSaverEnabled()){
            Log.d(TAG, "handleClick fail cause isDataSaverEnabled!");
            return;
        }
        /*@}*/
