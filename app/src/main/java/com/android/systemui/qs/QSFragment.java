...
public class QSFragment extends Fragment implements QS {
    ...
    public void makeSureNoOverlay() {
        Log.d(TAG, "makeSureNoOverlay: mQSDetail.VISIBLE = " + mQSDetail.VISIBLE +
                "mContainer.VISIBLE = " + mContainer.VISIBLE);
        if (mQSDetail.VISIBLE == View.VISIBLE && mContainer.VISIBLE == View.VISIBLE) {
