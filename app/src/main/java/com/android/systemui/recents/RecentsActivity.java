...
public class RecentsActivity extends Activity implements ViewTreeObserver.OnPreDrawListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /* SPRD: Bug 692448 new feature of quick cleaning. @{ */
        ...
        if (hasSoftKey) {
            if (clearButton.getLayoutParams() instanceof MarginLayoutParams) {
                int navHeight = res.getDimensionPixelSize(com.android.internal.R.dimen.navigation_bar_height);
                MarginLayoutParams params = (MarginLayoutParams) clearButton.getLayoutParams();
