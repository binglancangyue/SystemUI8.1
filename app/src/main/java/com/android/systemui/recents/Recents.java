...
import static com.android.systemui.statusbar.phone.PhoneStatusBarPolicy.RECENTS_SPRD;
...
import com.android.systemui.recents.sprd.RecentsSprdImpl;
...
public class Recents extends SystemUI
    ...
    public final static int SPRD_SHOW_SCREEN_PIN_REQUEST = 1;
    public final static int SPRD_LAUNCH_SPLIT_APP_PANEL = 2;
    public final static int SPRD_RECENTS_DRAWN = 3;
    public final static int SPRD_RECENTS_VISBILITY_CHANGED = 4;
    /* @} */
    ...
    public void start() {
        ...
        /* SPRD: new feature of sprd recents @{ */
        if (RECENTS_SPRD) {
            mImpl = new RecentsSprdImpl(mContext);
        } else {
        /* @} */
