    ...
    private void processLoadQueueItem(SystemServicesProxy ssp) {
        ...
        if (t != null) {
            ...
            if (!mCancelled) {
                ...
                if (RecentsDebugFlags.Static.EnableTaskLock) {
...
public class RecentsTaskLoader {
    ...
    ActivityInfo getAndUpdateActivityInfo(Task.TaskKey taskKey) {
        ...
        if (activityInfo != null && activityInfo.applicationInfo != null) {
            userId = android.os.UserHandle.getUserId(activityInfo.applicationInfo.uid);
        } else {
            userId = android.os.UserHandle.myUserId();
        }
        final boolean userIdNotMatched = (userId != taskKey.userId);
        if (activityInfo == null || userIdNotMatched) {
            ...
            if (!userIdNotMatched) mActivityInfoCache.put(cn, activityInfo);
        }
        return activityInfo;
    }
