...
public class TaskStackAnimationHelper {
    ...
    private static final int ENTER_FROM_HOME_ALPHA_DURATION = 50;
    ...
    private static final int DISMISS_TASK_DURATION = 50;
    private static final int DISMISS_ALL_TASKS_DURATION = 70;
