...
public class TaskStackView extends FrameLayout implements TaskStack.TaskStackCallbacks,
   ...
   public void updateLayoutAlgorithm(boolean boundScrollToNewMinMax,
    ...
    public void onStackTaskRemoved(TaskStack stack, Task removedTask, Task newFrontMostTask,
        ...
        if (animation != null && mLayoutAlgorithm.isInitialized()) {
            updateLayoutAlgorithm(true /* boundScroll */);
    ...
    public final void onBusEvent(final DismissAllTaskViewsEvent event) {
        ...
        final double availBefore = Recents.getSystemServices().getMemoryInfo().availMem;
        /* @} */
        ...
        event.addPostAnimationCallback(new Runnable() {
            ...
            public void run() {
                ...
                /* SPRD: new feature of showing memory tip @{ */
                Recents.getSystemServices().sendShowMemoryTip(availBefore);
                /* @} */
