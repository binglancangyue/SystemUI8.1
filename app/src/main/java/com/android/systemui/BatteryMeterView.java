...
public class BatteryMeterView extends LinearLayout implements
    ...
    /*SPRD : Bug 692440 add charge animation of batteryView*/
    ...
    private int mUser;
    private boolean lowRam = ActivityManager.isLowRamDeviceStatic();

    /*SPRD : Bug 692440 add charge animation of batteryView*/
    private static final boolean BATTERY_ANIMATION = true;
    /*@}*/
    ...
    private BroadcastReceiver mUpdateStatuaBarVisibleReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context ctx, Intent intent) {
            ...
            if (BATTERY_ANIMATION && mSprdDrawable != null) mSprdDrawable.setShouldAnimate(statusBarVisible);
                if (DEBUG_NOT_REFRESH) android.util.Log.d(TAG_NOT_REFRESH, "BatteryMeterView-onSystemUiVisibilityChange: statusBarVisible = " + statusBarVisible);
            }
    };
    ...
    public void onAttachedToWindow() {
        ...
        /*@}*/
        /*SPRD bug 723830:Battery percent not work in other user except owner*/
        if (!lowRam) {
            mReceiver = new UserBroadcastReceiver();
            getContext().registerReceiver(mReceiver, new IntentFilter(Intent.ACTION_USER_SWITCHED));
        }
        /*@}*/
        ...
        if (DEBUG_NOT_REFRESH) Log.d(TAG_NOT_REFRESH, "Clock registerReceiver");
        /* @} SPRD bug 814301&819675 :add control of whether refresh statusbar icons*/
    }
    ...
    public void onDarkChanged(Rect area, float darkIntensity, int tint) {
        ...
        if(mSprdDrawable != null){
            mSprdDrawable.setColors(foreground, background);
        }
        /*@}*/
    ...
    class UserBroadcastReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            //Log.d(VIEW_LOG_TAG, "onReceive action="+action);
            updateShowPercent();
        }
    }
    /*@}*/
