...
/*SPRD bug 781132 :Airplanemode display issue@{*/
...
//        onAirplaneModeChanged();
    ...
    /*SPRD bug 781132 :Airplanemode display issue@{*/
    private final class AirPlaneAction extends SinglePressAction {
        private AirPlaneAction() {
            super(TeleUtils.isAirplaneModeOn(mContext) ? R.drawable.ic_lock_airplane_mode : R.drawable.ic_lock_airplane_mode_off,
                    R.string.global_actions_toggle_airplane_mode);
        }
        ...
        public void onPress() {
            if (mHasTelephony && Boolean.parseBoolean(
                ...
                changeAirplaneModeSystemSetting(!TeleUtils.isAirplaneModeOn(mContext));
            }
        }
    }
    /*@}*/
...
//        mAirplaneModeOn.updateState(mAirplaneState);
    ...
    private static abstract class SinglePressAction implements Action {
        ...
        public View create(
            ...
            /* sprdroid Bug849868 nullpointerexception in systemui @{ */
            if (mIcon != null) {
    ...
    PhoneStateListener mPhoneStateListener = new PhoneStateListener() {
        ...
        public void onServiceStateChanged(ServiceState serviceState) {
            if (!mHasTelephony) return;
            /*SPRD bug 720950 :Airplanemode display issue@{*/
