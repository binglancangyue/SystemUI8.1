...
class SaveImageInBackgroundTask extends AsyncTask<Void, Void, Void> {
    ...
    private static final boolean SAVE_SPRD_EXTERNAL_STORAGE = true;
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
            ...
            Log.d(TAG,"compress_start");
            image.compress(Bitmap.CompressFormat.PNG, 100, out);
            Log.d(TAG,"compress_end");
            out.flush();
            out.close();

            /*SPRD bug 730738:Screenshot prompt error when SD card is full.{@*/
    ...
    protected void onPostExecute(Void params) {
        ...
        /*SPRD bug 729354:Take screenshot reset slow after one shot*/
...
class GlobalScreenshot {
    ...
    private boolean isMoveStatusDone = true;
    ...
    private void startAnimation(final Runnable finisher, int w, int h, boolean statusBarVisible,
        ...
        // has been taken.
        Log.d("GlobalScreenshot","startAnimation_start");
        ...
        mScreenshotAnimation.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                Log.d("GlobalScreenshot","startAnimation_end");
    ...
    private final MoveCallback mMoveCallback = new MoveCallback() {
        ...
        public void onCreated(int moveId, Bundle extras) {
            isMoveStatusDone = false;
        }
        @Override
        public void onStatusChanged(int moveId, int status, long estMillis) {
            if (PackageManager.isMoveStatusFinished(status)) {
                isMoveStatusDone = true;
            } else {
                isMoveStatusDone = false;
            }
        }
